...
export default function AboutPage() {
  return (
    <ContentPageShell>
      ...
      >
        <p className="max-w-prose text-base text-neutral-700 dark:text-white/85">
      ...
      <div className="pt-2">
        <Link
          href="/"
          className="inline-flex items-center justify-center rounded-lg bg-neutral-900 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400 dark:bg-white dark:text-black dark:hover:bg-neutral-200 dark:focus-visible:outline-white/80"
        >
          Explore
        </Link>
      </div>
