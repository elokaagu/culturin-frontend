...
function P({ children }: { children: ReactNode }) {
  return <p className="m-0 text-base leading-relaxed text-neutral-700 dark:text-white/80">{children}</p>;
}

function H2({ children }: { children: ReactNode }) {
  return <h2 className="m-0 text-xl font-semibold tracking-tight text-neutral-900 dark:text-white sm:text-2xl">{children}</h2>;
}
    ...
    >
      ...
      <article className="space-y-8">
        <header className="rounded-3xl border border-neutral-200 bg-white p-5 sm:p-8 dark:border-white/10 dark:bg-white/[0.03]">
          <p className="m-0 text-xs font-semibold uppercase tracking-[0.22em] text-neutral-500 dark:text-white/45">Policy</p>
          <h1 className="m-0 mt-3 text-3xl tracking-tight text-neutral-900 dark:text-white sm:text-5xl">Privacy policy</h1>
          ...
          <p className="m-0 mt-3 text-sm text-neutral-500 dark:text-white/55">Last updated: April 25, 2026</p>
        </header>
