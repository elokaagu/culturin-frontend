  ...
  return (
    <>
      ...
      <main className="min-h-screen w-full bg-black pt-[150px] text-white transition-colors sm:pt-[120px]">
        ...
        <div className="flex flex-col gap-2 overflow-x-auto px-5 py-5 sm:px-5">
          ...
          <div className="mx-auto w-full max-w-6xl overflow-x-auto px-2 pb-4 sm:px-4">
            <Hero />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2 overflow-x-auto px-5 py-5 sm:px-5">
          ...
          <div className="mx-auto w-full max-w-6xl overflow-x-auto px-2 pb-10 sm:px-4">
            <ProviderHero />
          </div>
        </div>
      </main>
