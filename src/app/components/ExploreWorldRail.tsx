        ...
        {[firstStory, secondStory].filter(Boolean).map((story) => {
          ...
          return (
            <article key={story.currentSlug} role="listitem" className="min-w-0">
              ...
              >
                <div className="relative aspect-[4/5] w-full overflow-hidden rounded-lg bg-neutral-200 ring-1 ring-neutral-200 dark:bg-neutral-900 dark:ring-white/15">
                  <Image
                    src={thumbSrc}
                    alt={story.title}
                    fill
                ...
                <h3 className="mt-3 line-clamp-2 text-[1.04rem] font-medium leading-tight tracking-tight text-neutral-900 dark:text-white">
                  {story.title}
                </h3>
                <p className="mt-2 line-clamp-2 text-sm leading-relaxed text-neutral-600 dark:text-white/70">{subtitle}</p>
              </Link>
            </article>
          );
        })}
        ...
        {featuredStory ? (
          <article role="listitem" className="min-w-0">
            <Link
              ...
              className="group block w-full no-underline outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-50 dark:focus-visible:ring-offset-black"
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden rounded-lg bg-neutral-200 ring-1 ring-neutral-200 dark:bg-neutral-900 dark:ring-white/15">
                <Image
              ...
              <h3 className="mt-3 line-clamp-2 text-[2.8rem] font-medium leading-[0.98] tracking-tight text-neutral-900 dark:text-white sm:text-[3.1rem]">
                {featuredStory.title}
              </h3>
              <p className="mt-2 max-w-4xl text-[1.06rem] leading-relaxed text-neutral-700 dark:text-white/80">
